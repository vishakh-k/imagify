      ...
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center ">
        ...
        <div >
          ...
          <p className="text-gray-600 text-xs">
            ...
            visualized efforlessly, Powered by advanced AI technology,the
